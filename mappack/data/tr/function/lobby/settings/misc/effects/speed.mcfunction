...
execute if score #effect.speed settings matches 0 run data modify entity @n[type=item_display,tag=settings.icon] item.components."minecraft:custom_model_data".floats[0] set value 192f
execute if score #effect.speed settings matches 1 run data modify entity @n[type=item_display,tag=settings.icon] item.components."minecraft:custom_model_data".floats[0] set value 191f
execute if score #effect.speed settings matches 2 run data modify entity @n[type=item_display,tag=settings.icon] item.components."minecraft:custom_model_data".floats[0] set value 19f
