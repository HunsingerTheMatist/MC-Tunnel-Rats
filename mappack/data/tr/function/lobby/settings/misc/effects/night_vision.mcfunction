...
execute if score #effect.night_vision settings matches 0 run data modify entity @n[type=item_display,tag=settings.icon] item.components."minecraft:custom_model_data".floats[0] set value 171f
execute if score #effect.night_vision settings matches 1 run data modify entity @n[type=item_display,tag=settings.icon] item.components."minecraft:custom_model_data".floats[0] set value 17f
