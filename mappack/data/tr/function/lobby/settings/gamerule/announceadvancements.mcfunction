...
execute if score #gr.announceadvancements settings matches 0 run data modify entity @n[type=item_display,tag=settings.icon] item.components."minecraft:custom_model_data".floats[0] set value 481f
execute if score #gr.announceadvancements settings matches 1 run data modify entity @n[type=item_display,tag=settings.icon] item.components."minecraft:custom_model_data".floats[0] set value 48f
