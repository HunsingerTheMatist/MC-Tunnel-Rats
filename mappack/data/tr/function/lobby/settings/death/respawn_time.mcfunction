...
execute if score #death.respawn.timer settings matches 0 run data modify entity @n[type=item_display,tag=settings.icon] item.components."minecraft:custom_model_data".floats[0] set value 261f
execute if score #death.respawn.timer settings matches 100 run data modify entity @n[type=item_display,tag=settings.icon] item.components."minecraft:custom_model_data".floats[0] set value 262f
execute if score #death.respawn.timer settings matches 200 run data modify entity @n[type=item_display,tag=settings.icon] item.components."minecraft:custom_model_data".floats[0] set value 263f
execute if score #death.respawn.timer settings matches 400 run data modify entity @n[type=item_display,tag=settings.icon] item.components."minecraft:custom_model_data".floats[0] set value 264f

execute if score #death.respawn.timer settings matches 0 run return run tellraw @p[tag=interactor] [{"color":"gold", "translate":"tr.text.setting.instruction.respawn_time", "with":[{"text":"0"}]}] 
execute if score #death.respawn.timer settings matches 100 run return run tellraw @p[tag=interactor] [{"color":"gold", "translate":"tr.text.setting.instruction.respawn_time", "with":[{"text":"5"}]}]
execute if score #death.respawn.timer settings matches 200 run return run tellraw @p[tag=interactor] [{"color":"gold", "translate":"tr.text.setting.instruction.respawn_time", "with":[{"text":"10"}]}]
execute if score #death.respawn.timer settings matches 400 run return run tellraw @p[tag=interactor] [{"color":"gold", "translate":"tr.text.setting.instruction.respawn_time", "with":[{"text":"20"}]}]