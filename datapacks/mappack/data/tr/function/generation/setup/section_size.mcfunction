execute store result storage tr:tmp section.x int 1 positioned ~1 ~ ~ align xyz run scoreboard players get @n[type=text_display,tag=admin.base,dx=1,dy=0,dz=0] x
execute store result storage tr:tmp section.y int 1 positioned ~1 ~ ~ align xyz run scoreboard players get @n[type=text_display,tag=admin.base,dx=1,dy=0,dz=0] y
execute store result storage tr:tmp section.z int 1 positioned ~1 ~ ~ align xyz run scoreboard players get @n[type=text_display,tag=admin.base,dx=1,dy=0,dz=0] z
